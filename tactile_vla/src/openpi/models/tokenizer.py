...
###########################################################################
## The tokenizers below support discretized action-token model variants. ##
## They are not used by the tactile-aware pi0.5 flow-matching config.    ##
###########################################################################
...
class FSQTokenizer:
    """
    FSQ tokenizer for FAST-style action-token models.
    """
