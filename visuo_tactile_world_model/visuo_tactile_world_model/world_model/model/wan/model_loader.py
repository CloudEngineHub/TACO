from ...utils.loader import load_model, hash_model_file
from ...utils.vram import AutoWrappedModule
...
class ModelPool:
    ...
    def clear_parameters(self, model: torch.nn.Module):
        for name, module in model.named_children():
            # AutoWrappedModule with disk_offload manages its own params via disk_map;
            # clearing them corrupts the module's _parameters registry.
