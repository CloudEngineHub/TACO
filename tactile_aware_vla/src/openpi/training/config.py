...
class LeRobotLiberoDataConfig(DataConfigFactory):
    ...
    action_dim: int = 7
    include_force_history: bool = False
...
def taco_tactile_ki_advantage_config() -> TrainConfig:
    """TACO tactile-aware VLA fine-tuning config.

    The model consumes RGB observations, robot state, an 8-step 12D tactile/force
    history, and a scalar advantage/success label. Knowledge insulation freezes
    the pretrained VLM prefix path while training the action-side modules and the
    tactile/advantage conditioning heads.
    """

    return TrainConfig(
        name="pi05_taco_tactile_ki_advantage",
        project_name="taco",
        ...
        data=LeRobotLiberoDataConfig(
            repo_id="taco_tactile_ki_advantage_example",
        ...
        weight_loader=weight_loaders.CheckpointWeightLoader(
            ...
            extra_missing_regex=".*(force_encoder|advantage_encoder|null_advantage).*",
        ),
...
_CONFIGS = [
    taco_tactile_ki_advantage_config(),
]
